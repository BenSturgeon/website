...
I recently stumbled across attachment theory and I think it's one of the most fun and useful theories around human relationships I have encountered for a while. It also seems to be widely misunderstood and commonly deployed in ways that have nothing to do with the actual research.
...
This is obviously much easier said than done, and the book provides a number of examples and motivations for this, but simply hearing this advice alone was hugely helpful for me.

## What is attachment theory?

Here's a great [YouTube short from Hannah Fry](https://www.youtube.com/shorts/GQ9y4c6AbCg) explaining it.

The experiment that created some of the key foundations of attachment theory originated with an interesting experiment with a bunch of babies in the 1970s. The researchers set up mothers and two-year-old babies in a room filled with lots of nice things for a baby to play with and added a research assistant. The mothers would leave the baby in the room with the research assistant for a few minutes and then return.
...
The third group basically turned away and shut the mother out, being angry and not showing they were upset. Interestingly in this group, the babies' heart rates were roughly as elevated as in the other groups, but they pretended to be unaffected. This group was classified as avoidant.

These roughly correspond to categories that continue to exist in adults. The studies linking the baby categories to adult attachment styles tended to find small to moderate effects, but in general the patterns of behaviour, however they might change, are still highly predictive and useful frameworks for understanding adult relationships.

## Against common takes in attachment theory discussions

It is easy to get distracted by misinformation or distractors if you aren't careful. Common failure modes:
...
- "Hmmm I used to be x, but now I think I am secure"
    - Maybe, but in general changing from an insecure attachment style to a secure one is really hard.
...
- "I am avoidant/anxious so there's not that much I can do besides find a secure."
    - It does seem like trying to date avoidants with an anxious attachment style is often quite harmful, and even avoidant-avoidant is quite challenging in my experience because the insecurity on both sides plays up very significantly.
        - However, with significant self-awareness about one's needs and tendencies it can be possible to make things work. It does require excellent communication skills and a willingness to be vulnerable that I think is genuinely rare.

## Thoughts

Recently, I've found attachment theory to be an extremely useful tool in navigating relationships. The most important part is understanding why I have these massive hangups (being anxiously attached), and how to handle that by communicating it directly to my partner. It's been a complete re-awakening to what relationships can be to approach my feelings with actual knowledge and tools to understand and ask for what I need, and also what kind of things my partner needs and what the actual issues are for them in the relationship.

My biggest problem was that I was approaching all relationships from the lens of dating avoidant women, who have very different needs and operate in a way that is very different to secure and anxious women. The approach I was taking was just hurtful to my anxious partner, and just made her sad and confused. All she wanted was more connection and vulnerability which I could easily have provided.

While I am still learning and understanding these concepts, they have already transformed my confidence to handle relationships going forward, and given me hope for what my future relationships will be like.
