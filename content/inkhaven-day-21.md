...
While I am unsure of what such a project might look like, it is interesting to think about the kinds of environments that we could create which could replicate similar experiences for models. For example, let's consider an analogous world to what a child experiences.

Imagine a human existing in a simulation where it has a home that it can adjust, build up using its resources, invest its efforts and resources into different projects involving the wider world, interact with other beings that have different characters and may be trustworthy or deceptive, cooperative or selfish. Give it loving guardians that protect it, encourage it, and share new things about the world with the agent. Create rules and order such that it learns that the world is generally a good place that rewards pro-social behaviour. Allow it to experience the consequences of its behaviour, and see how its actions may have good or bad effects, with different time horizons for these. Now let's imagine such a world but constructed for the AI, that it will experience in the form of tokens, but with all the same logic and structure to the world.
