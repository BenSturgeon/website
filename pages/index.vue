<template>
      ...
      <div>
        ...
        <p>
          My role is to find interesting and important ideas and distribute them
          to others in a way that adds value.
        </p>
        <p>
          I want to help people by removing tedious or superfluous activities
          from their lives so they have more time for awareness and
          contemplation.
        </p>
        ...
        <h2>Test func</h2>
        <p>
          link to my <nuxt-link to="/test" class="link">test</nuxt-link> page
        </p>
